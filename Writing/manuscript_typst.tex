...
\includegraphics[width=1.6in,height=\textheight]{figures/g_profit_quota_comp_stat.png}
...
\includegraphics[width=1.73in,height=\textheight]{figures/g_illustration_homogeneous.png}
...
\includegraphics[width=1.73in,height=\textheight]{figures/g_illustration_het.png}
...
\includegraphics[width=1.6in,height=\textheight]{figures/g_trade_effect_profit.png}
...
\includegraphics[width=1.73in,height=\textheight]{figures/g_illustration_homogeneous_with_trade.png}
...
\includegraphics[width=1.6in,height=\textheight]{figures/g_profit_ratio.png}
...
\includegraphics[width=1.6in,height=\textheight]{figures/g_opt_w_dist.png}
...
\addcontentsline{toc}{subsection}{Distribution of water-proxy conversion
factor}

\phantomsection\label{refs}
\begin{CSLReferences}{1}{0}
\bibitem[\citeproctext]{ref-grafton2018paradox}
