...
ggsave(here::here("Writing/figures/g_opt_w_dist.png"), g_opt_w_dist, height = 5, width = 6, dpi = 400)
```
...
ggsave("Writing/figures/g_profit_quota_w_vs_p.png", g_profit_quota_w_vs_p, height = 3.5, width = 6, dpi = 400)
```
...
ggsave("Writing/figures/g_trade_effect_profit.png", g_trade_effect_profit, height = 6, width = 6, dpi = 400)
```
...
ggsave("Writing/figures/g_profit_ratio.png", g_profit_ratio, height = 6, width = 6, dpi = 400)
```
...
ggsave("Writing/figures/g_illustration_homogeneous.png", g_illustration_homogeneous, height = 4.5, width = 6.5, dpi = 400)
```
...
ggsave("Writing/figures/g_illustration_homogeneous_with_trade.png", g_illustration_homogeneous_with_trade, height = 5, width = 6.5, dpi = 400)
```
...
ggsave("Writing/figures/g_illustration_het.png", g_illustration_het, height = 4.5, width = 6.5, dpi = 400)
```
